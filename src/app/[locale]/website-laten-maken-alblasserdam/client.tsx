...
const localBenefits = [
  ...
  },
  {
    ...
    description:
      "Bekijk het werk dat we voor andere bedrijven in Alblasserdam en omgeving hebben gemaakt.",
  },
];
...
const services = [
  {
    ...
    title: "Webdesign",
    description:
      "Een uniek ontwerp dat past bij jouw bedrijf en aanspreekt bij je doelgroep in Alblasserdam.",
  },
  {
    icon: Code,
    title: "Development",
  ...
  },
  {
    ...
    title: "Lokale SEO",
    description:
      "Gevonden worden in Alblasserdam en omgeving. We optimaliseren voor lokale zoekopdrachten.",
  },
  {
    icon: Shield,
...
export default function WebsiteLatenMakenAlblasserdamPageClient() {
  return (
    <div className="min-h-screen pt-32">
        ...
        <div className="relative z-10 mx-auto max-w-7xl px-6 lg:px-8">
          <div className="max-w-3xl">
            ...
            >
              ...
              <span className="text-gradient-accent">Alblasserdam</span>
            </motion.h1>
            <motion.p
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
            ...
            >
              Op zoek naar een webbureau in Alblasserdam? Wij maken professionele
              websites voor ondernemers in Alblasserdam en de Alblasserwaard. Lokaal,
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto">
              De voordelen van een website bureau uit Alblasserdam en omgeving
            </p>
          </motion.div>
      ...
      <section className="py-20">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          ...
          >
            <h2 className="text-3xl sm:text-4xl font-bold text-white mb-4">
              Onze diensten in Alblasserdam
            </h2>
            <p className="text-muted-foreground max-w-2xl mx-auto">
              Van ontwerp tot onderhoud, we helpen bedrijven in Alblasserdam met
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              <h2 className="text-3xl sm:text-4xl font-bold text-white mb-6">
                Professionele websites voor Alblasserdam
              </h2>
              <div className="space-y-4 text-muted-foreground">
                <p>
                  Als ondernemer in Alblasserdam weet je hoe belangrijk een goede
                  online aanwezigheid is. Of je nu een restaurant runt in het
                  Centrum, een toeristisch bedrijf hebt bij Kinderdijk, een
                  zorginstelling in Souburgh of een logistiek bedrijf op het
                  Overslagterrein - een professionele website is onmisbaar.
                </p>
                <p>
              ...
              <ul className="mt-6 space-y-2">
                ...
                <li className="flex items-center gap-2 text-white">
                  <Check className="h-4 w-4 text-accent" />
                  Gevonden worden in Alblasserdam
                </li>
                <li className="flex items-center gap-2 text-white">
                  <Check className="h-4 w-4 text-accent" />
            ...
            >
              ...
              <p className="mt-6 text-muted-foreground text-sm">
                Naast Alblasserdam zijn we ook actief in de hele Alblasserwaard en
      ...
      <section className="py-20">
        <div className="mx-auto max-w-4xl px-6 lg:px-8 text-center">
          ...
          >
            Website laten maken in Alblasserdam?
          </motion.h2>
          <motion.p
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
