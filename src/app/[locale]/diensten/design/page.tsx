...
const designServices: { id: string; icon: LucideIcon }[] = [
  { id: "customWebdesign", icon: Palette },
  { id: "responsiveDesign", icon: Smartphone },
  { id: "uiUxOptimization", icon: MousePointer2 },
  { id: "visualHierarchy", icon: Eye },
  { id: "designSystems", icon: Layers },
  { id: "microInteractions", icon: Sparkles },
];
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              <h2 className="text-3xl sm:text-4xl font-bold text-white mb-6">
                {t("benefits.title")}{" "}
                <span className="text-gradient-accent">{t("benefits.titleHighlight")}</span>
              </h2>
