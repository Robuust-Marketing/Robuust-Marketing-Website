...
const localBenefits = [
  ...
  },
  {
    ...
    description:
      "Bekijk het werk dat we voor andere bedrijven in Barendrecht en omgeving hebben gemaakt.",
  },
];
...
const services = [
  {
    ...
    title: "Webdesign",
    description:
      "Een uniek ontwerp dat past bij jouw bedrijf en aanspreekt bij je doelgroep in Barendrecht.",
  },
  {
    icon: Code,
    title: "Development",
  ...
  },
  {
    ...
    title: "Lokale SEO",
    description:
      "Gevonden worden in Barendrecht en omgeving. We optimaliseren voor lokale zoekopdrachten.",
  },
  {
    icon: Shield,
...
export default function WebsiteLatenMakenBarendrechtPageClient() {
  return (
    <div className="min-h-screen pt-32">
        ...
        <div className="relative z-10 mx-auto max-w-7xl px-6 lg:px-8">
          <div className="max-w-3xl">
            ...
            >
              ...
              <span className="text-gradient-accent">Barendrecht</span>
            </motion.h1>
            <motion.p
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
            ...
            >
              Op zoek naar een webbureau in Barendrecht? Wij maken professionele
              websites voor ondernemers in Barendrecht en de regio. Lokaal,
            ...
            >
              ...
              <div className="flex items-center gap-2">
                <MapPin className="h-4 w-4 text-accent" />
                <span className="text-sm text-muted-foreground">
                  Actief in Barendrecht en omstreken
                </span>
              </div>
            </motion.div>
          </div>
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto">
              De voordelen van een website bureau uit Barendrecht en omgeving
            </p>
          </motion.div>
      ...
      <section className="py-20">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto">
              Van ontwerp tot onderhoud, we helpen bedrijven in Barendrecht met
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              <h2 className="text-3xl sm:text-4xl font-bold text-white mb-6">
                Professionele websites voor Barendrecht
              </h2>
              <div className="space-y-4 text-muted-foreground">
                <p>
                  Als ondernemer in Barendrecht weet je hoe belangrijk een goede
                  online aanwezigheid is. Of je nu een accountant bent in het
                  Centrum, een schoonheidssalon runt in Carnisselande, een
                  hoveniersbedrijf hebt in Vrouwenpolder of een elektricien bent
                  in Buitenoord - een professionele website is onmisbaar.
                </p>
                <p>
              ...
              <ul className="mt-6 space-y-2">
                ...
                <li className="flex items-center gap-2 text-white">
                  <Check className="h-4 w-4 text-accent" />
                  Gevonden worden in Barendrecht
                </li>
                <li className="flex items-center gap-2 text-white">
                  <Check className="h-4 w-4 text-accent" />
            ...
            >
              ...
              <p className="mt-6 text-muted-foreground text-sm">
                Naast Barendrecht zijn we ook actief in de hele regio en
      ...
      <section className="py-20">
        <div className="mx-auto max-w-4xl px-6 lg:px-8 text-center">
          ...
          >
            Website laten maken in Barendrecht?
          </motion.h2>
          <motion.p
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
