...
const localBenefits = [
  ...
  },
  {
    ...
    description:
      "Bekijk het werk dat we voor andere bedrijven in Hendrik-Ido-Ambacht en omgeving hebben gemaakt.",
  },
];
...
const services = [
  {
    ...
    title: "Webdesign",
    description:
      "Een uniek ontwerp dat past bij jouw bedrijf en aanspreekt bij je doelgroep in Hendrik-Ido-Ambacht.",
  },
  {
    icon: Code,
    title: "Development",
  ...
  },
  {
    ...
    title: "Lokale SEO",
    description:
      "Gevonden worden in Hendrik-Ido-Ambacht en omgeving. We optimaliseren voor lokale zoekopdrachten.",
  },
  {
    icon: Shield,
...
export default function WebsiteLatenMakenHendrikIdoAmbachtPageClient() {
  return (
    <div className="min-h-screen pt-32">
        ...
        <div className="relative z-10 mx-auto max-w-7xl px-6 lg:px-8">
          <div className="max-w-3xl">
            ...
            >
              ...
              <span className="text-gradient-accent">Hendrik-Ido-Ambacht</span>
            </motion.h1>
            <motion.p
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
            ...
            >
              Op zoek naar een webbureau in Hendrik-Ido-Ambacht? Wij maken professionele
              websites voor ondernemers in Hendrik-Ido-Ambacht en de Drechtsteden. Lokaal,
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto">
              De voordelen van een website bureau uit Hendrik-Ido-Ambacht en omgeving
            </p>
          </motion.div>
      ...
      <section className="py-20">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          ...
          >
            <h2 className="text-3xl sm:text-4xl font-bold text-white mb-4">
              Onze diensten in Hendrik-Ido-Ambacht
            </h2>
            <p className="text-muted-foreground max-w-2xl mx-auto">
              Van ontwerp tot onderhoud, we helpen bedrijven in Hendrik-Ido-Ambacht met
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              <h2 className="text-3xl sm:text-4xl font-bold text-white mb-6">
                Professionele websites voor Hendrik-Ido-Ambacht
              </h2>
              <div className="space-y-4 text-muted-foreground">
                <p>
                  Als ondernemer in Hendrik-Ido-Ambacht weet je hoe belangrijk een goede
                  online aanwezigheid is. Of je nu een tandarts bent bij Het Veer,
                  een makelaar in Beverwijck, een kapper in De Volgerlanden of een
                  loodgieter in Sandelingen-Ambacht - een professionele website is onmisbaar.
                </p>
                <p>
                  ...
                  diensten in Hendrik-Ido-Ambacht.
                </p>
                <p>
              ...
              <ul className="mt-6 space-y-2">
                ...
                <li className="flex items-center gap-2 text-white">
                  <Check className="h-4 w-4 text-accent" />
                  Gevonden worden in Hendrik-Ido-Ambacht
                </li>
                <li className="flex items-center gap-2 text-white">
                  <Check className="h-4 w-4 text-accent" />
            ...
            >
              ...
              <p className="mt-6 text-muted-foreground text-sm">
                Naast Hendrik-Ido-Ambacht zijn we ook actief in de hele Drechtsteden en
      ...
      <section className="py-20">
        <div className="mx-auto max-w-4xl px-6 lg:px-8 text-center">
          ...
          >
            Website laten maken in Hendrik-Ido-Ambacht?
          </motion.h2>
          <motion.p
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
