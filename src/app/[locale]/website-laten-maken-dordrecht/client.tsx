...
const localBenefits = [
  ...
  },
  {
    ...
    description:
      "Bekijk het werk dat we voor andere bedrijven in Dordrecht en omgeving hebben gemaakt.",
  },
];
...
const services = [
  {
    ...
    title: "Webdesign",
    description:
      "Een uniek ontwerp dat past bij jouw bedrijf en aanspreekt bij je doelgroep in Dordrecht.",
  },
  {
    icon: Code,
    title: "Development",
  ...
  },
  {
    ...
    title: "Lokale SEO",
    description:
      "Gevonden worden in Dordrecht en omgeving. We optimaliseren voor lokale zoekopdrachten.",
  },
  {
    icon: Shield,
...
export default function WebsiteLatenMakenDordrechtPageClient() {
  return (
    <div className="min-h-screen pt-32">
        ...
        <div className="relative z-10 mx-auto max-w-7xl px-6 lg:px-8">
          <div className="max-w-3xl">
            ...
            >
              ...
              <span className="text-gradient-accent">Dordrecht</span>
            </motion.h1>
            <motion.p
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
            ...
            >
              Op zoek naar een webbureau in Dordrecht? Wij maken professionele
              websites voor ondernemers in Dordrecht en de Drechtsteden. Lokaal,
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto">
              De voordelen van een website bureau uit Dordrecht en omgeving
            </p>
          </motion.div>
      ...
      <section className="py-20">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          ...
          >
            <h2 className="text-3xl sm:text-4xl font-bold text-white mb-4">
              Onze diensten in Dordrecht
            </h2>
            <p className="text-muted-foreground max-w-2xl mx-auto">
              Van ontwerp tot onderhoud, we helpen bedrijven in Dordrecht met
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              <h2 className="text-3xl sm:text-4xl font-bold text-white mb-6">
                Professionele websites voor Dordrecht
              </h2>
              <div className="space-y-4 text-muted-foreground">
                <p>
                  Als ondernemer in Dordrecht weet je hoe belangrijk een goede
                  online aanwezigheid is. Of je nu een restaurant hebt in de
                  historische Binnenstad, een sportschool runt in Dubbeldam, een
                  adviesbureau hebt in Sterrenburg, een winkel in Crabbehof, een
                  bouwbedrijf in Stadspolders of een kapsalon in Wielwijk - een
                  professionele website is onmisbaar.
                </p>
                <p>
            ...
            >
              ...
              <p className="mt-6 text-muted-foreground text-sm">
                Naast Dordrecht zijn we ook actief in de hele Drechtsteden en
      ...
      <section className="py-20">
        <div className="mx-auto max-w-4xl px-6 lg:px-8 text-center">
          ...
          >
            Website laten maken in Dordrecht?
          </motion.h2>
          <motion.p
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
